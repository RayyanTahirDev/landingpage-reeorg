    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
      ...
      <div className="container mx-auto px-4 max-w-4xl pt-24 pb-16">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <p className="text-blue-600 mb-6">Last Updated: May 1, 2025</p>
          
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-700">1. Introduction</h2>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-700">2. Data We Collect</h2>
          <p className="text-blue-600">We may collect and process the following data about you:</p>
          <ul className="list-disc ml-6 my-4 text-blue-600">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-700">3. How We Use Your Data</h2>
          <p className="text-blue-600">We use your data to:</p>
          <ul className="list-disc ml-6 my-4 text-blue-600">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-700">4. Contact Us</h2>
          <p className="text-blue-600">
