    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
      ...
      <div className="container mx-auto px-4 max-w-4xl pt-24 pb-16">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-700">1. Agreement to Terms</h2>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-700">2. Use License</h2>
          <p className="text-blue-600">
            Permission is granted to temporarily access the materials on ReeOrg's website for personal,
            non-commercial transitory viewing only.
          </p>
          
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-700">3. Disclaimer</h2>
          <p className="text-blue-600">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-700">4. Limitations</h2>
          <p className="text-blue-600">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-700">5. Contact Us</h2>
          <p className="text-blue-600">
